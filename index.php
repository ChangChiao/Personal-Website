			...
			<div class="box">
               ...
               <!-- ===================section4================== -->
						...
						<div class="layer layer-scene" id="l4">
							...
							<?php
								$newsQuery = "SELECT * FROM news ORDER BY newsId DESC LIMIT 0,2";
								$newsRec = $pdo->query($newsQuery);
								$newArr = array();
								while($newsRow = $newsRec->fetch(PDO::FETCH_ASSOC)){
									$newsArr[] = $newsRow;
								}
							?>
							...
							<div class="l4-content">
								<div class="l4-card card"  onclick="location.href='newsInfo.php?newsId=<?php echo $newsArr[0]['newsId']; ?>'">
									<h3><?php echo $newsArr[0]['newsTitle']; ?></h3>
									<div class="l4-card-img">
										<img src="<?php echo $newsArr[0]['newsImg']; ?>">
									</div>	
									<p><?php echo $newsArr[0]['newsInfo_1']; ?>...</p>
									<span style="cursor: pointer;" onclick="location.href='newsInfo.php?newsId=<?php echo $newsArr[0]['newsId']; ?>'">閱讀全文</span>
								</div>
								<div class="l4-card card"  onclick="location.href='newsInfo.php?newsId=<?php echo $newsArr[1]['newsId']; ?>'">
									<h3><?php echo $newsArr[1]['newsTitle']; ?></h3>
									<div class="l4-card-img">
										<img src="<?php echo $newsArr[1]['newsImg']; ?>">
									</div>	
									<p><?php echo $newsArr[1]['newsInfo_1']; ?>...</p>
									<span style="cursor: pointer;" onclick="location.href='newsInfo.php?newsId=<?php echo $newsArr[1]['newsId']; ?>'">閱讀全文</span>
								</div>
							</div>	
						</div>
					...
					<!-- ================section5====================	 -->
						...
						<?php
							$comQuery = "SELECT * FROM comments ORDER BY comHeat DESC LIMIT 0,3";
							$comRec = $pdo->query($comQuery);
							$comArr = array();
							$memImg = array();
							while($comRow = $comRec->fetch(PDO::FETCH_ASSOC)){
								$comArr[] = $comRow;
								$memAccount = $comRow['memAccount'];

								$posterQuery = "SELECT * FROM memberdata WHERE memAccount = '$memAccount'";

								$posterRec = $pdo->query($posterQuery);
								$posterRow = $posterRec->fetch(PDO::FETCH_ASSOC);
								$memImg[] = $posterRow;
							}
						...
						<div class="l5-content">
								<div class="l5-card card"  onclick="location.href='forum-article.php?comId=<?php echo $comArr[0]['comId']; ?>'">
									<div class="member-info">
										<div class="l5-card-img">
											<img src="<?php echo $memImg[0]['memImg']; ?>">
										</div>	
										<div class="member-nickname">
											<?php echo $memImg[0]['memNickName']; ?>
										</div>
									</div>	
									<div class="discuss-each">
										<div class="discuss-title"><?php echo $comArr[0]['comTitle']; ?></div>
										<div class="discuss-date"><?php echo $comArr[0]['comDate']; ?></div>
									</div>
								</div>	
								<div class="l5-card card"  onclick="location.href='forum-article.php?comId=<?php echo $comArr[1]['comId']; ?>'">
									<div class="member-info">
										<div class="l5-card-img">
											<img src="<?php echo $memImg[1]['memImg']; ?>">
										</div>	
										<div class="member-nickname">
											<?php echo $memImg[1]['memNickName']; ?>
										</div>
									</div>	
									<div class="discuss-each">
										<div class="discuss-title"><?php echo $comArr[1]['comTitle']; ?></div>
										<div class="discuss-date"><?php echo $comArr[1]['comDate']; ?></div>
									</div>
								</div>
								<div class="l5-card card"  onclick="location.href='forum-article.php?comId=<?php echo $comArr[2]['comId']; ?>'">
									<div class="member-info">
										<div class="l5-card-img">
											<img src="<?php echo $memImg[2]['memImg']; ?>">
										</div>	
										<div class="member-nickname">
											<?php echo $memImg[2]['memNickName']; ?>
										</div>
									</div>	
									<div class="discuss-each">
										<div class="discuss-title"><?php echo $comArr[2]['comTitle']; ?></div>
										<div class="discuss-date"><?php echo $comArr[2]['comDate']; ?></div>
									</div>
								</div>
						...
						<div class="m-layer m-layer-scene" id="scene1">
							...
							<div id="owl-demo" class="owl-carousel owl-theme">
								...
								<div class="item">
									<div class="m-l1-card m-card">
										<a href="products.php">
											<img src="images/slider/slider04.jpg" alt="The Last of us">
										</a>	
									</div>
								</div>
